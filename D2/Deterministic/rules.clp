...
; -- Rule 12A: Mock Interview Urgency for Imminent Interviews --
(defrule rule-12A-mock-interview-urgency
   (practice-habits
      (user-id ?id)
      (days-until-interview ?days&:(<= ?days 14)))
   (user-profile
...
=>
   (assert
      (recommendation
         ...
         (rule-id "12A")
         (category "interview-preparation")
         (advice "Mock interviews should be a top priority in the next two weeks.")
         (reason "interview-soon-low-mock-exposure")))
)

; -- Rule 12B: Ready for Medium-Level Interview Problems --
(defrule rule-12B-ready-for-medium-interview-problems
   (practice-habits
      (user-id ?id)
      (days-until-interview ?days&:(<= ?days 14)))
   (user-profile
...
=>
   (assert
      (recommendation
         ...
         (rule-id "12B")
         (category "interview-preparation")
         (advice "Focus on medium-level interview problems in the next two weeks.")
         (reason "interview-soon-ready-for-advancement")))
)

; -- Rule 12C: Need to Strengthen Fundamentals --
(defrule rule-12C-strengthen-fundamentals
   (practice-habits
      (user-id ?id)
      (days-until-interview ?days&:(<= ?days 14)))
   (user-profile
...
=>
   (assert
      (recommendation
         ...
         (rule-id "12C")
         (category "interview-preparation")
         (advice "Strengthen fundamentals before advancing to medium-level problems.")
         (reason "interview-soon-low-exposure")))
)
